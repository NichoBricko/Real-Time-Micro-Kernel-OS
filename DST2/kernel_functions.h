#ifndef kernal_functions_H
#define kernal_functions_H
...
//  Add and delte from list
exception insert_task(list* listobject, listobj* object);
listobj * extract_head(list * List);
listobj * createNode(TCB *task);
listobj *removeNode (list* List, listobj* Node);


//Pop and add msg Mailbox
exception Msg_add_toMailbox(mailbox* mBox, msg* message);
